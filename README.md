...
- Utilisez des mots précis et dont vous connaissez bien le sens. Évitez l'emploi du jargon très spécifique de l'entreprise dont elle seule peut donner la définition. Si de nombreux acronymes et termes techniques, *utilisez un lexique*.
- Évitez le "franglais" et l'abus de l'anglais;
- Orthographe, style et ponctuation corrects;
- Veillez à la lisibilité et l'utilité des schémas, figures et graphiques;
- *Légendez* vos figures (identifiant, description). Ainsi, vous pouvez vous y référer dans le texte (*Comme le montre la figure 12, ...*).Si pas de référence dans le texte, supprimez-la ou placez la en annexe (support optionnel pour aller plus loin)
